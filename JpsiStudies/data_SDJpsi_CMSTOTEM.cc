...
//void data_SDJpsi_CMSTOTEM(string const& outputFileName = "data_SDJpsi_CMSTOTEM.root",const Double_t t_proton_down_=0.03, const Double_t t_proton_up_=1.0,const Int_t Bin_mass=200, const Int_t nevt_max = 5000.0){
void data_SDJpsi_CMSTOTEM(vector<string> const& fileNames, string const& outputFileName = "output.root",const Double_t t_proton_down_=0.03, const Double_t t_proton_up_=1.0,const Int_t Bin_mass=200 ,const Int_t nevt_max = -1){
	bool verbose = false;
	...
	/*vector<TString>* vdirs = new vector<TString>; 
	  vdirs->push_back("/storage1/eliza/TOTEM/Muon/");
	  vector<TString>* vfiles = new vector<TString>;
			...
			if( good_proton_right ){
				...
				if (t_region_right) {
					...
					if(pfXiMinusReco+xi_proton_right>0.009){
						...
						histosTH1F["proton_right_t_halosel"]->Fill( fabs(t_proton_right), event_weight );
					}
			...
			if( good_proton_left ){
				...
				if (t_region_left) {
					...
					if(pfXiPlusReco+xi_proton_left>0.009){
						...
						histosTH1F["proton_left_t_halosel"]->Fill( fabs(t_proton_left), event_weight );
