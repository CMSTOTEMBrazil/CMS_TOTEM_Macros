...
void POMPYT_Jpsi_PU(string const& outputFileName = "pompty_16MarchSDPlus_pu.root", const Double_t t_proton_down_=0.0, const Double_t t_proton_up_=1.0,const Int_t Bin_mass=200,  const Int_t nevt_max = -1){
	...
	//const char *dirname="/storage2/eliza/TOTEM/POMPYT_SDMinus_UATree/";
	const char *dirname="/storage2/eliza/TOTEM/POMPYT_SDPlus_UATree/";
	//const char *dirname="/storage2/eliza/TOTEM/POMWIG_DYPlus_UATree/";
	//const char *dirname="/storage2/eliza/TOTEM/POMWIG_DYMinus_UATree/";
	const char *ext=".root";
