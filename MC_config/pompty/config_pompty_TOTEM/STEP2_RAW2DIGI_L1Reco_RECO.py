...
# with command line options: STEP2 --step RAW2DIGI,L1Reco,RECO --conditions START53_V7A::All --pileup NoPileUp --datamix NODATAMIXER --eventcontent AODSIM --datatier AODSIM
